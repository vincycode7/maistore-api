...
route_path = [
    [
        TokenRefresh, 
        ["/refresh"]
    ], # https://mistore.com/refresh
    [
        UserRegister, 
        ["/register"]
    ],  # https://mistore.com/register
    [
        UserLogin, 
        ["/login"]
    ],  # https://mistore.com/register
    ...
    [
        User, 
        ["/user/<int:userid>"]
    ],  # https://mistore.com/user/1
    [
        UserList, 
        ["/users"]
    ],  # https://mistore.com/users
    [
        Store, 
        ["/store/<int:storeid>", "/store"]
    ],  # https://maistore.com/store/1
    [
        StoreList, 
        ["/stores"]
    ],  # https://maistore.com/store
    [
        ProductList, 
        ["/products"]
    ],  # https://mistore.com/product
    [
        Product,
