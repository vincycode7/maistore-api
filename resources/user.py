...
class UserRegister(Resource):
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        help="middlename cannot be blank",
        case_sensitive=False,
    )
    parser.add_argument(
        name="lastname",
    ...
    parser.add_argument(
        name="phoneno", type=str, required=True, help="phone number cannot be blank"
    )
    parser.add_argument(
        name="address",
        type=str,
        required=False,
        help="Home address of user",
        case_sensitive=False,
    )
    parser.add_argument(
        name="admin",
...
class User(Resource):
    ...
    parser.add_argument(
        name="password", type=str, required=False, help="password cannot be blank"
    )
    parser.add_argument(
        name="email", type=str, required=True, help="email cannot be blank"
    )
    ...
    parser.add_argument(
        name="lga", type=str, required=False, help="user's lga", case_sensitive=False
    )
    parser.add_argument(
        name="state",
        type=str,
