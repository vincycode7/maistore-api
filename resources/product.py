...
class Product(Resource):
    ...
    parser.add_argument(
        "productname", type=str, required=True, help="productname field is required"
    )
    parser.add_argument(
        "price", type=float, required=True, help="price field is requried"
    )
    parser.add_argument(
        "category",
        type=str,
        required=True,
        help="category the product falls in is required",
    )
    parser.add_argument(
        "store_id",
        type=str,
        required=True,
        help="store_id of the user posting the product is required",
    )
    parser.add_argument(
        "quantity",
        type=int,
    ...
    parser.add_argument(
        ...
        default=False,
        required=False,
        help="1 if propuct is available and 0 if not available",
    )
