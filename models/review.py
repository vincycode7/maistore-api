...
class ReviewModel(db.Model):
    ...
    product_id = db.Column(db.Integer, db.ForeignKey('product.id'), index=False, unique=False, nullable=False)
    store_id = db.Column(db.Integer, db.ForeignKey("store.id"), index=False, unique=False, nullable=False)
    user_id = db.Column(db.Integer, db.ForeignKey("user.id"), index=False, unique=False, nullable=False)
    product_rating = db.Column(db.Integer, db.ForeignKey("ratingtype.id"), index=False, unique=False)
